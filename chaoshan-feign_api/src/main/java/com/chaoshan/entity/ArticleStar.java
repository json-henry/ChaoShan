...
@ApiModel(value = "com-chaoshan-entity-ArticleStar")
@Data
@TableName(value = "chaoshan.cs_article_star")
public class ArticleStar implements Serializable {
    ...
    /**
     * 是否删除 0已删除 1未删除 default 0
     */
    @TableField(value = "is_delete")
    @ApiModelProperty(value = "是否删除 0已删除 1未删除 default 0")
    @TableLogic
